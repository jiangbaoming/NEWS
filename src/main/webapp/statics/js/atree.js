...
layui.define('jquery', function (exports) {
    ...
    var enterSkin = 'layui-atree-enter',
        Atree = function (options) {
            ...
            this.renameBtnLabelKey = this.props.renameBtnLabel || props.renameBtnLabel;
        ...
        return {
            ...
            menu: function () {
                return '<div class="layui-atree-menu">' +
                    ...
                    '<span class="layui-atree-rename">' + that.renameBtnLabelKey + '</span>' +
                    '</div>'
            }
        }
    ...
    Atree.prototype.bindUlEvent = function (li, item) {
        ...
        //重命名方法
        typeof options.renameClick === 'function' && that.rename(li, item);
    ...
    //修改方法回调
    Atree.prototype.rename = function (elem, item) {
        var that = this.$vm,
            options = this.$options;
        var node = elem.children('.layui-atree-node');
        var renameBtn = node.children('.layui-atree-menu').children('.layui-atree-rename')
        var arrow = node.children('.layui-atree-spread')
        var ul = elem.children('ul'),
            a = node.children('a'),
        ...
        renameBtn.on('click', renameEvent);
    }
